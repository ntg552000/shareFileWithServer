...
CREATE DATABASE /*!32312 IF NOT EXISTS*/ `crm` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
CREATE TABLE `FILE_MANAGER` (
  ...
  `SERVICE_ID` varchar(36) NOT NULL COMMENT 'map với id của đối tượng sở hữu file, vd như id của POSTS hoặc id của ITEM',
  `STREAM_URL` varchar(255) DEFAULT NULL COMMENT 'lưu stream url hoặc đường dẫn api dowload file',
  `SERVER_PATH` varchar(255) NOT NULL COMMENT 'đường dẫn lưu trong server',
  `TYPE` tinyint NOT NULL COMMENT '0: file trong bài viết, 1: file ảnh title',
...
INSERT INTO `FILE_MANAGER` VALUES ('72f8b212-b12e-40ed-a5a6-e2018844e54b','23370903-672f-4827-8946-3b7a71a0eaf8','http://10.248.158.167:1112/media/23370903-672f-4827-8946-3b7a71a0eaf8/72f8b212-b12e-40ed-a5a6-e2018844e54b.jpg','C:\\Users\\ADMIN\\Desktop\\media\\23370903-672f-4827-8946-3b7a71a0eaf8\\72f8b212-b12e-40ed-a5a6-e2018844e54b.jpg',1,'2023-05-11 16:22:33'),('cda48327-2bf8-42b5-8ff5-3d35d9bd494f','7e8e8a51-2423-4972-9fa4-561505cb3f93','http://10.248.158.167:1112/media/7e8e8a51-2423-4972-9fa4-561505cb3f93/cda48327-2bf8-42b5-8ff5-3d35d9bd494f.png','C:\\Users\\ADMIN\\Desktop\\media\\7e8e8a51-2423-4972-9fa4-561505cb3f93\\cda48327-2bf8-42b5-8ff5-3d35d9bd494f.png',1,'2023-05-17 08:03:42'),('e7fe6e44-2a11-45c2-ba3d-0158f317cc3e','ce365509-ff4b-4e46-a5a9-5a03b1be1444','http://10.248.158.167:1112/media/ce365509-ff4b-4e46-a5a9-5a03b1be1444/e7fe6e44-2a11-45c2-ba3d-0158f317cc3e.jpg','C:\\Users\\ADMIN\\Desktop\\media\\ce365509-ff4b-4e46-a5a9-5a03b1be1444\\e7fe6e44-2a11-45c2-ba3d-0158f317cc3e.jpg',1,'2023-05-11 15:57:29');
...
CREATE TABLE `ITEM` (
  ...
  `INTRODUCTION` text,
  `CONTENT` longtext COMMENT 'chứa string dạng html lưu nội dung bài viết (kiểu content blog)',
  `STATUS` tinyint NOT NULL DEFAULT '1' COMMENT '0: không hoạt động, 1: hoạt động, 2: hết hàng',
  `PRICE` int DEFAULT NULL COMMENT 'giá',
  `PRIORITY` tinyint NOT NULL DEFAULT '0' COMMENT 'Độ ưu tiên, nổi bật',
  `CREATE_AT` timestamp NOT NULL,
...
CREATE TABLE `ORDER` (
  ...
  `STATUS` tinyint NOT NULL DEFAULT '1' COMMENT '0: hủy, 1: chờ xác nhận, 2: đang giao hàng, 3: thành công',
  `CREATE_AT` timestamp NOT NULL,
  `UPDATE_AT` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `ORDER_DETAIL` (
  ...
  `AMOUNT` int NOT NULL COMMENT 'số lượng item',
  `ITEM_PRICE` int DEFAULT NULL COMMENT 'giá tiền mỗi item (capture data)',
...
CREATE TABLE `POSTS` (
  ...
  `INTRODUCTION` text,
  `CONTENT` longtext COMMENT 'chứa string dạng html lưu nội dung bài viết (kiểu content blog)',
  `STATUS` tinyint NOT NULL DEFAULT '1' COMMENT '0: không hoạt động, 1: hoạt động',
  `PRIORITY` tinyint DEFAULT '0' COMMENT 'Độ ưu tiên, nổi bật của bài viết',
  `CREATE_AT` timestamp NOT NULL,
  `UPDATE_AT` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
INSERT INTO `POSTS` VALUES ('23370903-672f-4827-8946-3b7a71a0eaf8','1','','1',1,1,'2023-05-11 16:22:33','2023-05-11 16:37:00'),('7e8e8a51-2423-4972-9fa4-561505cb3f93','Minh họa bát tự',NULL,'Minh họa bát tự',1,0,'2023-05-17 08:03:43',NULL),('ce365509-ff4b-4e46-a5a9-5a03b1be1444','a',NULL,'test',1,0,'2023-05-11 15:57:30','2023-05-11 16:09:08');
...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2023-03-29 04:25:11',NULL),('diagnostics.include_raw','OFF','2023-03-29 04:25:11',NULL),('ps_thread_trx_info.max_length','65535','2023-03-29 04:25:11',NULL),('statement_performance_analyzer.limit','100','2023-03-29 04:25:11',NULL),('statement_performance_analyzer.view',NULL,'2023-03-29 04:25:11',NULL),('statement_truncate_len','64','2023-03-29 04:25:11',NULL);
...
--
-- Current Database: `greenonlineshopping`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `greenonlineshopping` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
-- Dump completed on 2023-05-17  8:22:13
